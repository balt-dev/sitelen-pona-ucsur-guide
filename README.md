...
Alternatively, there is an input method using [Fcitx5](https://github.com/fcitx/fcitx5) that can be found [here](https://github.com/balt-dev/ilo-sitelen/tree/trunk). Details on the installation process can be found on its repository.
